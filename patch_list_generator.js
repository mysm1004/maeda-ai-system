// patch_list_generator.js
// Phase 4: 営業リスト生成エンジン (list-generator.js) をデプロイ
var fs = require('fs');
var execSync = require('child_process').execSync;

// npm install exceljs
console.log('[Phase4] exceljs インストール中...');
try {
  execSync('cd /home/ubuntu/kabeuchi-system && npm install exceljs', { stdio: 'inherit' });
  console.log('[Phase4] exceljs インストール完了');
} catch(e) {
  console.error('[Phase4] exceljs インストール失敗:', e.message);
}

// list-generator.js を作成
var targetFile = '/home/ubuntu/kabeuchi-system/src/services/list-generator.js';

var code = `// list-generator.js
...
// Claude API呼び出し
ListGenerator.prototype._callClaude = function(systemPrompt, userPrompt) {
  var self = this;
...
// ChatGPT API呼び出し
ListGenerator.prototype._callChatGPT = function(systemPrompt, userPrompt) {
  var self = this;
  ...
  switch (stepNum) {
    ...
    case 10:
      ...
      return self._callClaude(
        ...
        return self.lineQA.askUserViaLine(question, 'list_sample_check', 10, 60);
...
console.log('[Phase4] list-generator.js 作成完了: ' + targetFile);

console.log('\n============================');
console.log('patch_list_generator.js 完了');
console.log('============================');
